...
*/
{
    ...
    for (k=0; k< n_exact_ir_valley_locs_count-1; k++){
        ...
        if (an_exact_ir_valley_locs[k+1]-an_exact_ir_valley_locs[k] >10){
			...
			int64_t n_nume_temp = (int64_t)n_y_ac * n_x_dc_max;
			n_nume = (int32_t)(n_nume_temp >> 7);
			int64_t n_denom_temp = (int64_t)n_x_ac * n_y_dc_max;
			n_denom = (int32_t)(n_denom_temp >> 7);
	...
	if (n_ratio_average >= 0 && n_ratio_average < sizeof(uch_spo2_table)/sizeof(uch_spo2_table[0])) {
